...
export const Class11MathsContent: ClassContent = {
    id: "cl11_maths",
    name: "Mathematics Class 11",
    description: "Advanced mathematics concepts for Class 11 students preparing for higher education",
    learningObjectives: [
        "Building advanced algebraic concepts and problem-solving skills",
        "Understanding calculus fundamentals and their applications",
        "Developing analytical and logical reasoning through mathematical proofs",
        "Exploring statistical methods and probability theory"
    ],
    contentCovered: [
        "Sets and Functions",
        "Algebra",
...
export default Class11MathsContent; 